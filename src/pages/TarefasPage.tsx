  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-10 md:gap-12">
      <PageHeader
        eyebrow="05 — Operação"
        title="Tarefas"
        description="Do backlog à conclusão — o fluxo do estúdio em colunas. Arraste os cards para atualizar o status."
        action={
      ...
      <section className="animate-fade-in-up" style={{ animationDelay: "80ms" }}>
        <KanbanBoard<TarefaItem>
          ...
          onMove={(activeId, overColumnId, overIndex) => {
            moveItem(activeId, overColumnId as TarefaStatus, overIndex)
          }}
